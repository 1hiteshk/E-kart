...
const Header = () => {
  ...
  const getdata = useSelector((state) => state.cartreducer.carts);           // useSelector reducer ke under se state ki value get krne ki help krega
   console.log(getdata);
                      ...
                      <>
                       <tr>
                        <td>
                          ...
                          <img src={e.imgdata} alt="/" style={{height:"5rem",width:"5rem"}} />
                          </NavLink>
                        </td>
                        <td>
                          <p>{e.rname}</p>
